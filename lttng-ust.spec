...
Version  : 2.12.10
Release  : 25
URL      : https://lttng.org/files/lttng-ust/lttng-ust-2.12.10.tar.bz2
Source0  : https://lttng.org/files/lttng-ust/lttng-ust-2.12.10.tar.bz2
Source1  : https://lttng.org/files/lttng-ust/lttng-ust-2.12.10.tar.bz2.asc
...
%setup -q -n lttng-ust-2.12.10
cd %{_builddir}/lttng-ust-2.12.10
pushd ..
cp -a lttng-ust-2.12.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713663799
unset LD_AS_NEEDED
