...
Source0  : https://lttng.org/files/lttng-ust/lttng-ust-2.14.0.tar.bz2
Source1  : https://lttng.org/files/lttng-ust/lttng-ust-2.14.0.tar.bz2.asc
...
License  : BSD-2-Clause BSD-3-Clause FSFAP GPL-2.0 GPL-3.0 LGPL-2.1 MIT
...
%setup -q -n lttng-ust-2.14.0
cd %{_builddir}/lttng-ust-2.14.0
pushd ..
cp -a lttng-ust-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751294164
unset LD_AS_NEEDED
...
cp %{_builddir}/lttng-ust-%{version}/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/lttng-ust/07c1ab270255cf247438e2358ff0c18835b6a6ce || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/lttng-ust/3630f1ffcec0e075bf446b88c7b507b1287b571d || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/FSFAP.txt %{buildroot}/usr/share/package-licenses/lttng-ust/da20b47077b3106fb65720d6fef309f39043fa60 || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/lttng-ust/3cb34cfc72e87654683f2894299adf912d14b284 || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/lttng-ust/3cb34cfc72e87654683f2894299adf912d14b284 || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/lttng-ust/d731920113454e58292b53feedd262e531cae0f1 || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/lttng-ust/fa05e58320cb7c64786b26396f4b992579a628bc || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/lttng-ust/fa05e58320cb7c64786b26396f4b992579a628bc || :
cp %{_builddir}/lttng-ust-%{version}/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/lttng-ust/adadb67a9875aeeac285309f1eab6e47d9ee08a7 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/include/lttng/ust-abi-old.h
...
/V3/usr/lib64/liblttng-ust-ctl.so.6.0.0
...
/usr/lib64/liblttng-ust-ctl.so.6
/usr/lib64/liblttng-ust-ctl.so.6.0.0
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/lttng-ust/07c1ab270255cf247438e2358ff0c18835b6a6ce
/usr/share/package-licenses/lttng-ust/3630f1ffcec0e075bf446b88c7b507b1287b571d
/usr/share/package-licenses/lttng-ust/3cb34cfc72e87654683f2894299adf912d14b284
/usr/share/package-licenses/lttng-ust/adadb67a9875aeeac285309f1eab6e47d9ee08a7
/usr/share/package-licenses/lttng-ust/d731920113454e58292b53feedd262e531cae0f1
/usr/share/package-licenses/lttng-ust/da20b47077b3106fb65720d6fef309f39043fa60
/usr/share/package-licenses/lttng-ust/fa05e58320cb7c64786b26396f4b992579a628bc
