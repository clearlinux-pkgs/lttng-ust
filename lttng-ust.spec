...
Source0  : https://lttng.org/files/lttng-ust/lttng-ust-2.13.5.tar.bz2
Source1  : https://lttng.org/files/lttng-ust/lttng-ust-2.13.5.tar.bz2.asc
...
%prep
%setup -q -n lttng-ust-2.13.5
cd %{_builddir}/lttng-ust-2.13.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664571473
